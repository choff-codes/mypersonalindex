...
public:
    ...
    holdingsRow(const security &s, const snapshotPortfolio &info,
...
public:
    ...
    mainHoldingsModel(const QList<baseRow*> &rows, QList<int> viewableColumns, const snapshotPortfolio &info, QTableView *parent = 0):
