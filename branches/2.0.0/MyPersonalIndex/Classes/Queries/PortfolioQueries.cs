...
namespace MyPersonalIndex
{
    ...
    {
        public static string InsertPortfolio(string Name, bool Dividends, decimal NAVStart, int CostCalc, int AAThreshold, DateTime StartDate)
        {
        ...
        public static string UpdatePortfolio(int Portfolio, string Name, bool Dividends, decimal NAVStart, int CostCalc, int AAThreshold, DateTime StartDate)
        {
