...
GO
Insert Into [Settings] ([DataStartDate],[LastPortfolio],[Version],[WindowX],[WindowY],[WindowHeight],[WindowWidth],[WindowState],[Splits],[TickerDiv]) Values ({ts '2008-01-02 12:00:00'},null,1.01,null,null,null,null,null,1,1);
GO
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (3,N'SELECT NAV AS NAV
FROM NAV
WHERE Portfolio = %Portfolio%
AND Date = ''%EndDate%''',N'Current Index Value',2);
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (4,N'SELECT %TotalValue%',N'Current Value',0);
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (5,N'SELECT (CASE WHEN Days = 0 THEN 0
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (6,N'SELECT SQRT((SUM(POWER(Change,2))-POWER(SUM(Change)/COUNT(*),2)) / COUNT(*))
FROM NAV 
WHERE Portfolio = %Portfolio%
AND Date BETWEEN ''%StartDate%'' AND ''%EndDate%''',N'Daily Standard Deviation',1);
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (7,N'SELECT MAX(Date)
FROM NAV
WHERE Portfolio = %Portfolio% 
AND Date BETWEEN ''%StartDate%'' AND ''%EndDate%''',N'Date',4);
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (8,N'SELECT COUNT(*) 
FROM NAV 
WHERE Portfolio = %Portfolio%
AND Date BETWEEN ''%StartDate%'' AND ''%EndDate%''',N'Days Invested',3);
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (9,N'SELECT (CASE WHEN Days = 0 THEN 0
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (10,N'SELECT MIN(Change)
FROM NAV
WHERE Portfolio = %Portfolio%
AND Date BETWEEN ''%StartDate%'' AND ''%EndDate%''',N'Max % Down',1);
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (11,N'SELECT Date
FROM NAV
WHERE Portfolio = %Portfolio%
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (12,N'SELECT MAX(Change)
FROM NAV
WHERE Portfolio = %Portfolio%
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (14,N'SELECT MAX(NAV)
FROM NAV
WHERE Portfolio = %Portfolio%
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (16,N'SELECT MAX(TotalValue)
FROM NAV
WHERE Portfolio = %Portfolio%
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (18,N'SELECT MIN(NAV)
FROM NAV
WHERE Portfolio = %Portfolio%
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (20,N'SELECT MIN(TotalValue)
FROM NAV
WHERE Portfolio = %Portfolio%
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (22,N'SELECT (CASE WHEN DATEDIFF(day, ''%StartDate%'', ''%EndDate%'') / 30 = 0 THEN a.NAV / b.NAV - 1
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (23,N'SELECT SQRT(22) * SQRT((SUM(POWER(Change,2))-POWER(SUM(Change)/COUNT(*),2)) / COUNT(*))
FROM NAV
WHERE Portfolio = %Portfolio%
AND Date BETWEEN ''%StartDate%'' AND ''%EndDate%''',N'Monthly Standard Deviation',1);
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (24,N'SELECT ''%TotalValue%'' - TotalValue
FROM NAV a
WHERE Portfolio = %Portfolio%
AND Date = ''%PreviousDay%''',N'Net Change',0);
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (25,N'SELECT (a.NAV / b.NAV - 1) * 100 AS NAV
FROM NAV a
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (26,N'SELECT (CASE WHEN z >= 0 THEN  (1.0 - 0.39894228 * exp( -z * z / 2.0 ) * t * ( t *( t * ( t * ( t * 1.330274429 + -1.821255978 ) + 1.781477937 ) + -0.356563782 ) + 0.319381530 ))
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (27,N'SELECT 100 - (CASE WHEN z >= 0 THEN  (1.0 - 0.39894228 * exp( -z * z / 2.0 ) * t * ( t *( t * ( t * ( t * 1.330274429 + -1.821255978 ) + 1.781477937 ) + -0.356563782 ) + 0.319381530 ))
        ELSE ( 0.39894228 * exp( -z * z / 2.0 ) * t * ( t *( t * ( t * ( t * 1.330274429 + -1.821255978 ) + 1.781477937 ) + -0.356563782 ) + 0.319381530 )) END) * 100 AS Probability
FROM (SELECT (CASE WHEN YearlyGain / StdDev >= 0 THEN 1.0 / ( 1.0 + 0.2316419 * (YearlyGain / StdDev) ) ELSE 1.0 / ( 1.0 - 0.2316419 * (YearlyGain / StdDev) ) END) AS t,
	  YearlyGain / StdDev AS z
	  FROM (SELECT SQRT(250) * SQRT((SUM(POWER(Change,2))-POWER(SUM(Change)/COUNT(*),2)) / COUNT(*)) / 100 AS StdDev
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (28,N'SELECT (CASE WHEN DATEDIFF(day, ''%StartDate%'', ''%EndDate%'') / 365 = 0 THEN a.NAV / b.NAV - 1
...
GO
Insert Into [UserStatistics] ([ID],[SQL],[Description],[Format]) Values (29,N'SELECT SQRT(250) * SQRT((SUM(POWER(Change,2))-POWER(SUM(Change)/COUNT(*),2)) / COUNT(*))
FROM NAV
WHERE Portfolio = %Portfolio%
